...
/// 		doivent	donc pas être modifiés, sauf si OpenStreetMap change le nom des attributs.
/// 	</para>
/// </summary>
public class XmlAttributes {
	...
	/// <summary>Nom de l'attribut indiquant le matériau d'un objet.</summary>
	public const string CUSTOM_MATERIAL = "material";

	/// <summary>Nom de l'attribut indiquant la couleur d'un objet.</summary>
	public const string OVERLAY_COLOR = "color";


	/// <summary>Nom de l'attribut indiquant le type d'une zone de loisir.</summary>
	...
	/// <summary>Nom de l'attribut indiquant le type de condition d'un seuil.</summary>
	public const string THRESHOLD_CONDITION = "condition";

	/// <summary>Nom de l'attribut indiquant la valeur de la propriété d'un dispositif.</summary>
