...
public class TRGDelaunay
{
	...
	public TRGDelaunay (NodeGroup build)
	{
		...
		//UnityEngine.Debug.Log("liste " + listNode.Count);
	}
	...
	public bool isWithin(Triangle tri , Node n)
	{
		...
		/* UnityEngine.Debug.Log("nalat " + tri.getNoeudA().getLatitude() + " nblat " + tri.getNoeudB().getLatitude() + " nclat " + tri.getNoeudC().getLatitude());
        UnityEngine.Debug.Log("nalon " + tri.getNoeudA().getLongitude() + " nblon " + tri.getNoeudB().getLongitude() + " nclon " + tri.getNoeudC().getLongitude());
        UnityEngine.Debug.Log("centre lat " + tri.getCentre().getLatitude() + " lon " + tri.getCentre().getLongitude());*/
		...
		//UnityEngine.Debug.Log("mod A " + moduleA + " mod B " + moduleB);
	...
	public void start()
	{
		...
		// On retire les triangles contenant les noeuds de la boite englobante
